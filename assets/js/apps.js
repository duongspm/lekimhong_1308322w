...
/* GGmap*/
NN_FRAMEWORK.ggmap = function () {
    if (isExist($(".ggmap-btn"))) {
        $('body').on("click", ".ggmap-btn", function() {
            $(".ggmap-btn").removeClass("active");
            $(this).addClass("active");
...
/* Slick */
NN_FRAMEWORK.SlickSanpham = function(){
    $('.slick-sanpham').slick({
        centerMode: true,
        infinite: true,
        centerPadding: '0',
...
$(document).ready(function(){
    ...
    NN_FRAMEWORK.loadPagingCongtrinh();
